...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'index.htm', 160, false),)), $this); ?>
...
/templates/default/css/home.css" rel="stylesheet" type="text/css" />
...
/main.php?cg_u_type=1&m=product&s=admin_buyorder">已买到的产品</a></li>
...
/?m=product&s=cart_number"></script></strong>种产品</a><i></i></span>
            </li>
            <li class="favorite">
                <div class="menu">
                    <a href="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/main.php?cg_u_type=1" class="menu-hd">我的收藏<b></b></a>
                    ...
                    <ul>
                        <li><a href="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/main.php?cg_u_type=1&m=sns&s=admin_share_product">收藏的产品</a></li>
                        <li><a href="<?php echo $this->_tpl_vars['config']['weburl']; ?>
...
<?php else: ?>image/default/home/avatar.png<?php endif; ?>"></div>
                </div>
                <div class="info-right">
                	<div class="attention-box">
                        <div class="attention clearfix">
                            <ul>
                                <li><a href="#"><b class="large"><?php echo $this->_tpl_vars['count']['f']; ?>
</b></a><span>粉丝</span></li>
                                <li><a href="#"><b class="large"><?php echo $this->_tpl_vars['count']['g']; ?>
</b></a><span>关注</span></li>
                                <li><a href="#"><b class="large"><?php echo $this->_tpl_vars['count']['v']; ?>
</b></a><span>访问</span></li><li class="clear"></li>
                            </ul>
                        </div>
                    </div>
...
">发私信</a></span>
							<?php else: ?>
								<a data_type="followbtn" data-param="{'mid':'<?php echo $_GET['uid']; ?>
