<?php /* Smarty version 2.6.20, created on 2016-03-04 16:59:47
         compiled from login_sina.htm */ ?>
...
/api/ad.php?id=1'></script></div>
            <div class="form">
            <span style="font-size:16px;color:#063; line-height:20px;">请用您的用户名和密码绑定账户登录，是新用户，请先注册。</span>
            <form id="login" name="login" action="login_sina.php" method="post">
