...
{	
	//审核所有会员
	$sql="update ".MEMBER." set statu=2 where statu=1 or statu='' or statu is null";
	$db->query($sql);
	unset($sql);
}
    ...
    <div class="bigboxbody">
      <table width="100%" border="0" cellspacing="0" cellpadding="1" align="center" class="menu">
        <tr class="theader">
          ...
          <td width="175"  align="left" >会员审核</td>
...
//		$scl.=" and area='$_SESSION[area]'";	
	...
	$sql="SELECT * from ".MEMBER."  WHERE 1 $scl";
	if($_GET['order']) 
...
?>
        <tr onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this,'odd')">
          ...
          <td width="66" align="center"><?php echo htmlspecialchars($v['userid']); ?></td>
          <td width="175" align="left"> [<?php echo $member_group[$v['statu']];?>] <?php echo htmlspecialchars($v['user']); ?></td>
