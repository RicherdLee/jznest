...
$logistic_app_id=$logistics_config['logistic_app_id']?$logistics_config['logistic_app_id']:"";
$logistic_api_sceret=$logistics_config['logistic_api_sceret']?$logistics_config['logistic_api_sceret']:"";
define("Logistic_API_Id", $logistic_app_id);
define("Logistic_API_Sceret", $logistic_api_sceret);
if($_GET["com"]&&$_GET["nu"])
{
...
{
	$api_id=Logistic_API_Id;
	$api_sceret=Logistic_API_Sceret;
