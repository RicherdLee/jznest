...
<table width="100%" height="100%" id="frametable" cellpadding="0" cellspacing="0">
	<tr>
    	<td colspan="2" height="60">
        	<div id="header">
            	<div class="logo"><img width="" src="../image/logo.png" width="100px" height="43px"></div>
            	<div class="info">
...
<div class="copyright">
	<p>Powered by <a target="_blank" href="">杞盏燕农</a></p>
	<p>&copy; 2007-2015</p>
</div>
<script>
var headers = new Array('index','global','pay','product','member','shop','business','website','running','tools','guestbook');
var menukey = '';
