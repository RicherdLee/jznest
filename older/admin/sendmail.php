...
if(isset($_POST["action"]))
{
	...
	$db->query("select a.lastLoginTime,a.user,a.name as contact,a.email from ".MEMBER." a where a.userid='$_POST[userid]'");
    $cons=$db->fetchRow();
...
//============================
$db->query("select a.email from ".MEMBER." a  where a.userid='$_GET[userid]'");
$userd=$db->fetchRow();
//============================
if(isset($_GET["modid"]))
{
