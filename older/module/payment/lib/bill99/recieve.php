	...
	if ($ok == 1) { 
		...
		switch($_REQUEST[payResult]){
				...
				case '10':
						...
						$rtnUrl="http://localhost/mallbuilder/module/payment/lib/demo/show.php?msg=success";
				...
				default:
						...
						$rtnUrl="http://localhost/mallbuilder/module/payment/lib/demo/show.php?msg=false";
						...
						$rtnUrl="http://localhost/mallbuilder/module/payment/lib/demo/show.php?msg=error";
