...
class consult
{
	...
	function add_question()
	{
		...
		$sql="insert into ".CONSULT." (`catid`,product_id,product_name,member_id,member_name,question,answer,answer_id,question_time,answer_time,status) values ('$_POST[catid]','$_POST[pid]','$_POST[pname]','$buid','$user','$con','','0','".time()."','','1')";
		$this -> db->query($sql);
	}
}
?>