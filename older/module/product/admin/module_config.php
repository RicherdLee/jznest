  ...
  <div class="bigboxbody">
    <form name="sysconfig" action="" method="post">
      <table width="100%" cellspacing="0">
        ...
        <tr>
          <td height="22" align="left"><pre id="line1">产品详情</pre></td>
          <td align="left" ><input class="text" name="title3" type="text" id="title3" value="<?php echo $reg_config['title3'];?>" size="10" />
            <br />
            <span class="bz">[title]标题[catname]类别名[keyword]产品关键词[des]产品摘要[brand]品牌</span></td>
          <td align="left" ><input class="text" name="keyword3" type="text" id="keyword3" size="10" value="<?php echo $reg_config['keyword3'];?>" />
            <br />
            <span class="bz">[title]标题[catname]类别名[keyword]产品关键词[des]产品摘要[brand]品牌</span></td>
          <td align="left" ><input class="text" name="description3" type="text" id="description3" size="10" value="<?php echo $reg_config['description3'];?>" />
            <br />
            <span class="bz">[title]标题[catname]类别名[keyword]产品关键词[des]产品摘要[brand]品牌</span></td>
        </tr>
        <tr>
