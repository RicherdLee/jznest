...
$weixinlangtable = $GLOBALS['jz']->table('weixin_lang');
$weixincfgtable = $GLOBALS['jz']->table('weixin_cfg');
$weixinbonustable = $GLOBALS['jz']->table('weixin_bonus');
$weixinpointtable = $GLOBALS['jz']->table('weixin_point');
$weixinconfigtable = $GLOBALS['jz']->table('weixin_config');
$weixinkeywordstable = $GLOBALS['jz']->table('weixin_keywords');
