...
<center>
    ...
    <div style="height:125px;"></div>
        <div class="logo"><a href="<{$config.weburl}>" title="返回首页"><img src="/image/logo.png" width="160px" height="70px"/></a></div>
           <div class="bottom">
              ...
              <div><label><span class="wz"><?php echo lang_show('password');?>:</span>                            
                        ...
                        <div class="bwz">
                        Copyright <a target="_blank" href="#">&copy; 2011-2015 极盏燕农
                        </div>     
                               </td>
                                  </tr>
                                  <tr>
